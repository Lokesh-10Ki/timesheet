...
const numberEditor = (day) => {
 ...
 const footerGroup = (
   <ColumnGroup className="bg-[#ffe5ee] ">
     <Row>
       <Column footer="Total Hours" className="p-column-title bg-[#ffe5ee] " />
       <Column className=" bg-[#ffe5ee] " />
       <Column className="" />
       <Column className="" />
       <Column className="" footer={total.mon} />
       <Column className="" footer={total.tue} />
       <Column className="" footer={total.wed} />
       <Column className="" footer={total.thu} />
       <Column className="" footer={total.fri} />
       <Column className="" footer={total.sat} />
       <Column className="" footer={total.sun} />
       <Column className="" footer={total.overall} />
     </Row>
     <Row>
       <Column footer="Machine Hours"></Column>
     </Row>
     <Row>
       <Column footer="Break Hours"></Column>
     </Row>
   </ColumnGroup>
 );
            ...
            <Box pt="5px">
              ...
              >
                <div className="p-datatable card p-fluid">
                  ...
                  >
                    <Column field="projectType" key="projectType" />
                    <Column field="projectName" key="projectName" />
                    <Column
                      field="task"
                      key="task"
